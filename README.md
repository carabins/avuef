...
# Intro
Решения ставшими классикой, vuex/redux/flux - выполняют свои задачи многословно, что не всегда бывает удобно. Мне, как и многим показалось излишним описывать отдельно каждую мутацию изменения состояния. Это одна из первопричин возникновения текущего решения. 
